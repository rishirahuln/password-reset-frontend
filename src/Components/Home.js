...
//     try {
//       const response = await axios.get(`${process.env.REACT_APP_BASE_URL}/repo/view`, { withCredentials: true });
//       if (response) {
...
//     try {
//       const response = await axios.delete(`${process.env.REACT_APP_BASE_URL}/repo/${repo._id}`, { withCredentials: true });
//       if (response) {
//         getAllRepo();
//       }
//     } catch (error) {
...
const Home = () => {
    return <div className="text-center mt-5">
        <h3 className="m-5">Welcome to Home page</h3>
        <h5>This is a Password Reset Flow assignment</h5>
    </div>
}
